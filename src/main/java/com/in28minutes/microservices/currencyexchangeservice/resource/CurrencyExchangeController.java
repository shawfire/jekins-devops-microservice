package net.shawfire.microservices.currencyexchangeservice.resource;
...
import net.shawfire.microservices.currencyexchangeservice.util.environment.InstanceInformationService;
